...
setwd("~/Dropbox/git/timema-eco-evo-2020/")
library(plotrix)
# all arthropod data 
...
```{r Calculate Mass-Abundance Relationships - Gabbys Way}
...
```{r Calculate Mass-Abundance Relationships - Tims Way}
